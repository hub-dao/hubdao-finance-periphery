...
enum RouterVersion {
  IHubdaoRouter01 = 'IHubdaoRouter01',
  IHubdaoRouter02 = 'IHubdaoRouter02'
}

describe('IHubdaoRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.IHubdaoRouter01]: fixture.router01,
        [RouterVersion.IHubdaoRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IHubdaoRouter01]: 102516,
              [RouterVersion.IHubdaoRouter02]: 102538
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.IHubdaoRouter01]: 109420,
              [RouterVersion.IHubdaoRouter02]: 109420
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
