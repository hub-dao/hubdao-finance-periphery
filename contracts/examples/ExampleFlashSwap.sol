...
import '@hubdao-finance/hubdao-core/contracts/interfaces/IHubdaoCallee.sol';
...
contract ExampleFlashSwap is IHubdaoCallee {
    ...
    constructor(address _factory, address _factoryV1, address router) public {
        ...
        factory = _factory;
        WETH = IWETH(IHubdaoRouter01(router).WETH());
    }
    ...
    function hubdaoCall(address sender, uint amount0, uint amount1, bytes calldata data) external override {
        ...
        if (amountToken > 0) {
            ...
            uint amountRequired = HubdaoLibrary.getAmountsIn(factory, amountETH, path)[0];
